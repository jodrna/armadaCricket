...
testing_RA_sum_wl_br = trainData[trainData.innings == 1].groupby(['wickets', 'ballsremaining'])['RA_sum'].mean().reset_index().sort_values(by=['wickets', 'ballsremaining'], ascending=[True, False])
...
#
#
# trainData.columns = ['matchID', 'ID', 'tier', 'date', 'year', 'competition', 'venue', 'host', 'home', 'away', 'battingTeam', 'inningNumber',
#                      'totalRuns', 'totalInningRuns', 'totalInningRunsEnd', 'isWicket', 'totalInningWickets', 'totalInningWicketsEnd',
