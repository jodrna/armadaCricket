...
# -------------------------
data = pd.read_csv(
    PROJECT_ROOT / 'women/expBall&runsToCome/data/Cleaned_t20bbb3_adjusted_runs_to_come_w.csv',
    parse_dates=['date']
)
...
data.to_csv(PROJECT_ROOT / 'women/expBall&runsToCome/data/dataClean_w.csv', index=False)
