...
hundredData_test = hundredData[hundredData.ballsremaining == 1]
# -------------------------
# Load t20 data
# -------------------------
t20Data = data[data.competition != 'The Hundred (Women\'s Comp)']
t20Data_test = t20Data[t20Data.ballsremaining == 1]
test2 = data.groupby(['ballsremaining'])['runs_to_come'].mean().reset_index()
