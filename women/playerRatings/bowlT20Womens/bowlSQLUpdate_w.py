...
# run the files
runpy.run_path(str(script_dir / '2_bowlDataClean_w.py'))
runpy.run_path(str(script_dir / '3_bowlModel_w.py'))
runpy.run_path(str(script_dir / '4_bowlReplacement_w.py'))
runpy.run_path(str(script_dir / '5_bowlReversion_w.py'))
