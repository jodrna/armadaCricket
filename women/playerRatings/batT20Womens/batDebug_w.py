...
def get_ratings_path(debug_config):
    if debug_config['model'] == 'jungle':
        return PROJECT_ROOT / 'women/playerRatings/batT20Womens/outputs/batRatingsJungle3_w.csv'

    if debug_config['model'] == 'rasoi':
        return PROJECT_ROOT / 'women/playerRatings/batT20Womens/outputs/batRatingsRasoi3_w.csv'
...
bat_model_results = runpy.run_path(PROJECT_ROOT / 'women/playerRatings/batT20Womens/3_batModel_w.py', init_globals={'DEBUG_CONFIG': DEBUG_CONFIG})
...
replacement_results = runpy.run_path(PROJECT_ROOT / 'women/playerRatings/batT20Womens/4_batReplacement_w.py', init_globals={'DEBUG_CONFIG': DEBUG_CONFIG})
...
runpy.run_path(PROJECT_ROOT / 'women/playerRatings/batT20Womens/5_batReversion_w.py')
...
# Create combined PDF
# -------------------------
output_path = PROJECT_ROOT / 'women/playerRatings/batT20Womens/outputs' / f'debug_{DEBUG_CONFIG["model"]}_{DEBUG_CONFIG["type"]}_{DEBUG_CONFIG["batsman"].replace(" ", "_")}.pdf'
