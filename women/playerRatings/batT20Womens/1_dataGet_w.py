...
allData =  pd.read_sql_query('''select id, matchid, date,
                                ...
                                bowlerid, bowler, byes, legbyes, noball, wide, extras, runs_raw, runs - noball - byes runs, bowlerwicket wkt, realexprbat, realexpwbat, realexpwbowl, realexprbowl, ballsremaining, bowlerball
