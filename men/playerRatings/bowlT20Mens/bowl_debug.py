...
def get_ratings_path(debug_config):
    if debug_config['model'] == 'jungle':
        return PROJECT_ROOT / 'men/playerRatings/bowlT20Mens/outputs/bowlRatingsJungle3.csv'

    if debug_config['model'] == 'rasoi':
        return PROJECT_ROOT / 'men/playerRatings/bowlT20Mens/outputs/bowlRatingsRasoi3.csv'
...
bowl_model_results = runpy.run_path(PROJECT_ROOT / 'men/playerRatings/bowlT20Mens/3_bowlModel.py', init_globals={'DEBUG_CONFIG': DEBUG_CONFIG})
...
replacement_results = runpy.run_path(PROJECT_ROOT / 'men/playerRatings/bowlT20Mens/4_bowlReplacement.py', init_globals={'DEBUG_CONFIG': DEBUG_CONFIG})
...
runpy.run_path(PROJECT_ROOT / 'men/playerRatings/bowlT20Mens/5_bowlReversion.py')
...
# Create combined PDF
# -------------------------
output_path = PROJECT_ROOT / 'men/playerRatings/bowlT20Mens/outputs' / f'debug_{DEBUG_CONFIG["model"]}_{DEBUG_CONFIG["type"]}_{DEBUG_CONFIG["bowler"].replace(" ", "_")}.pdf'
