...
# Imports
# -------------------------
bowl_data = pd.read_csv(PROJECT_ROOT / 'men/playerRatings/bowlT20Mens/data/bowlDataCombined.csv', parse_dates=['date'])   # ball by ball data
...
# Export
# -------------------------
bowl_data.to_csv(PROJECT_ROOT / 'men/playerRatings/bowlT20Mens/data/bowlDataCombinedClean.csv', index=False)
