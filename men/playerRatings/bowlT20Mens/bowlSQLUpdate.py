...
runpy.run_path(str(script_dir / '2_bowlDataClean.py'))
runpy.run_path(str(script_dir / '3_bowlModel.py'))
runpy.run_path(str(script_dir / '4_bowlReplacement.py'))
runpy.run_path(str(script_dir / '5_bowlReversion.py'))
...
player_info = pd.read_csv(PROJECT_ROOT / 'men/playerRatings/bowlT20Mens/auxiliaries/playerInfo.csv', parse_dates=['dob'])
