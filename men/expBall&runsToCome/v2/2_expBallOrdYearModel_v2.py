...
# v2 of 2_expBallOrdYearModel.py - model unchanged, only reads step 1 v2's output and writes its own v2 output
...
# export - v2 file name (v1's export is commented out)
masterLookup.to_csv(PROJECT_ROOT / 'men/expBall&runsToCome/outputs/2_masterLookup_v2.csv', index=False)
