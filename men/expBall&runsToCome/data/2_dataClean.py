...
# import
trainData = pd.read_csv(PROJECT_ROOT / 'men/data/Cleaned_t20bbb3_adjusted_runs_to_come_3.csv', parse_dates=['date'])
...
trainData.to_csv(PROJECT_ROOT / 'men/data/dataClean.csv', index=False)
